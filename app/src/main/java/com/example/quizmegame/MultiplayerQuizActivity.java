...
public class MultiplayerQuizActivity extends AppCompatActivity {
    ...
    private final long timer_value = TimeUnit.SECONDS.toMillis(20);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        ProgressDialog progressDialog = new ProgressDialog(MultiplayerQuizActivity.this);
        progressDialog.setCancelable(false);
        progressDialog.setMessage("Waiting for opponents...");
        progressDialog.show();


        dbreference.child("multiplayer_rooms").addValueEventListener(new ValueEventListener() {
            @Override
                                ...
                                if (getPlayersCount == 2){
                                    ...
                                    for (DataSnapshot players : rooms.getChildren()){
                                        ...
                                        if(getPlayerId.equals(userId)){
                                            ...
                                            dbreference.child("multiplayer_rooms").removeEventListener(this);
            ...
            public void onClick(View v) {
                ...
                mHandler.postDelayed(new Runnable() {
                    ...
                    public void run() {
                        ...
                        timeDifference = timer_value - currentTime;
                    }
                },timeDifference);  //wait 2sec
        ...
        back_btn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                countDownTimer.cancel();
                // once the room is completed remove from db reference
                dbreference.child("multiplayer_rooms").child(roomId).removeValue();
                finish();
            }
        });
        ...
        mHandler.postDelayed(new Runnable() {
            ...
            public void run() {
                if(currentQuestNum < questionList.size()){
                    ...
                    questsNum.setText("Round " + (currentQuestNum +1));
    ...
    private void dislayResults(){
        ...
        dbreference.child("multiplayer_rooms").child(roomId).removeValue();
        Intent intent = new Intent(MultiplayerQuizActivity.this,HomeActivity.class);  //QuizResults
